        ...
        <div>
            <StyledSvg pathId={dataId} onClick={handleClicking} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 125.83 125.84">
                <g id="Schijf_1_-_Kind" data-name="Schijf 1 - Kind">
                    ...
                    <path id="Schijf_1_-_Kind_-_Conatieve_functie" data-name="Schijf 1 - Kind - Conatieve functie" class="cls-1"
                    d="M313,324.27a30.81,30.81,0,0,1-30.75,0l8.2-14.21a14.33,14.33,0,0,0,14.35,0Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_1_-_Kind_-_Gedragsfunctie" data-name="Schijf 1 - Kind - Gedragsfunctie" class="cls-1"
                    d="M328.38,297.64A30.72,30.72,0,0,1,313,324.27l-8.2-14.2A14.31,14.31,0,0,0,312,297.64Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_1_-_Kind_-Affectieve_functie" data-name="Schijf 1 - Kind -Affectieve functie" class="cls-1"
                    d="M328.38,297.64H312a14.3,14.3,0,0,0-7.18-12.43L313,271A30.72,30.72,0,0,1,328.38,297.64Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_1_-_Kind_-_Fysieke_functie" data-name="Schijf 1 - Kind - Fysieke functie" class="cls-1"
                    d="M313,271l-8.2,14.2a14.3,14.3,0,0,0-14.35,0l-8.2-14.2A30.81,30.81,0,0,1,313,271Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_1_-_Kind_-_Morele_functie" data-name="Schijf 1 - Kind - Morele functie" class="cls-1"
                    d="M290.46,285.21a14.35,14.35,0,0,0-7.18,12.43H266.9A30.74,30.74,0,0,1,282.26,271Z"
                    transform="translate(-234.72 -234.72)" />
                    <circle id="Schijf_1_-_Kind-2" data-name="Schijf 1 - Kind" class="cls-1" cx="62.92" cy="62.92" r="14.36" />
                </g>
                <g id="Schijf_2_-_Pedagogisch_besef" data-name="Schijf 2 - Pedagogisch besef">
                    <path id="Schijf_2_-_Pedagogisch_besef-2" data-name="Schijf 2 - Pedagogisch besef" class="cls-1"
                    ...
                    class="cls-1" d="M360.3,297.64H341.72a44.06,44.06,0,0,0-21-37.58l11.52-14.69A62.62,62.62,0,0,1,360.3,297.64Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_2_-_Pedagogisch_besef-3" data-name="Schijf 2 - Pedagogisch besef" class="cls-1"
                ...
                <g id="Schijf_2_-_Hechting" data-name="Schijf 2 - Hechting">
                    ...
                    data-name="Schijf 2 - Hechting - Zelfreflectie en mentaliseren" class="cls-1"
                    ...
                    data-name="Schijf 2 - Hechting - Sensitiviteit en responsiviteit" class="cls-1"
                    ...
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_2_-_Hechting_-_Beschikbaarheid" data-name="Schijf 2 - Hechting - Beschikbaarheid" class="cls-1"
                    d="M287.46,340.54l-4.73,18a62.72,62.72,0,0,1-35-22.95l14-12.26A44.12,44.12,0,0,0,287.46,340.54Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_2_-_Hechting_-_Acceptatie" data-name="Schijf 2 - Hechting - Acceptatie" class="cls-1"
                    d="M261.8,323.32l-14,12.26A62.35,62.35,0,0,1,235,297.64h18.58A43.82,43.82,0,0,0,261.8,323.32Z"
                    transform="translate(-234.72 -234.72)" />
                    <path id="Schijf_2_-_Hechting-2" data-name="Schijf 2 - Hechting" class="cls-1"
